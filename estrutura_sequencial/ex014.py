...
peso = float(input('João, informe quantos kilos de peixe trouxe dessa vez: '))
excesso = peso - 50
multa = excesso * 4

print(f'Você excedeu o limite de 50kg. Trouxe {excesso}kg a mais.')
print(f'Precisa pagar uma multa no valor de R$ {multa:.2f}')
